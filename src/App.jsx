        ...
        <main className="bg-black text-white min-h-screen mt-16">
          <div className="max-w-7xl mx-auto px-4 sm:px-6 md:px-12 py-12 grid grid-cols-1 md:grid-cols-2 gap-12">
            ...
            <div className="md:sticky md:top-20 self-start space-y-6">
              <h2 className="text-2xl sm:text-3xl font-bold">Grand Theft Auto: San Andreas</h2>
              <a
              ...
              <img
                src="src/assets/ChatGPT Image Sep 2, 2025, 10_25_12 AM.png"
        ...
        <section className="bg-black text-white min-h-screen grid grid-cols-1 lg:grid-cols-[300px_1fr] gap-8 px-4 sm:px-6 md:px-12 py-12">
          ...
          <div className="space-y-12">
            ...
            <section>
              ...
              <hr />
              {/* Three Images Horizontal with Links */}
              <div className="flex justify-center gap-6 mt-8">
                <div className="w-1/1 flex flex-col items-center space-y-3">
                  <img
                    src="src/assets/ChatGPT Image Sep 2, 2025, 10_40_56 AM.png"
                  ...
                  >
                    <button
                      className="px-6 py-2 bg-cyan-500 text-white font-semibold rounded-full shadow-md 
                ...
                <div className="w-1/1 flex flex-col items-center space-y-3">
                  <img
                    src="src/assets/ChatGPT Image Sep 2, 2025, 10_51_10 AM.png"
                ...
                <div className="w-1/1 flex flex-col items-center space-y-3">
                  <img
                    src="src/assets/ChatGPT Image Sep 2, 2025, 10_35_05 AM.png"
